...
const AddRecipeForm = () => {
    ...
    return (
        <form className="flex flex-col space-y-3" onSubmit={handleSubmit(onSubmit)}>
            ...
            <Select options={ingredient} value={selectedOptions} onChange={handleChange} isMulti={true} placeholder="Ingredients" className="max-w-[385px] min-h-12 px-5 py-2 rounded-lg border-b-[2px] border-b-[#5B5F97] border-l-4 border-l-[#5B5F97] mt-4" />
